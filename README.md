...
| <b>Advanced</b> | Use a secure password management solution! | I recommend: <br></br><a href="https://keepass.info/"><b>Keepass</b> <img width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/0/04/KeePass_icon.svg"></img></a>  Windows  <br></br> <a href="https://keepassxc.org/"><b>KeepassXC</b> <img width="30" height="30" src="http://keepassxc.org/images/keepassxc-logo.svg"></img></a>  MacOS <br></br>  <a href="https://apps.apple.com/us/app/authpass-password-manager/id1479297675"><b>AuthPass</b> <img width="30" height="30" src="https://static.crozdesk.com/web_app_library/providers/logos/000/008/475/box/authpass---password-manager-1570718935-logo.png?1570718935"></img></a> iOS | <b>Note:</b> Providers of online password managers that handle your master key might be breached and leak your credentials. |
...
| Standard | Encrypt your drives. | For encrypting drives/volumes I recommend <a href="https://www.veracrypt.fr/en/Home.html"><b>Veracrypt</b>  <img width="30" height="30" src="https://avatars.githubusercontent.com/u/7925881?s=200&v=4"></img></a> | | |
...
| Standard | Install a endpoint protection solution on Windows <b>if neccesary</b>. | You may want to install a EDR solution, depending on how securely the computer is configured and used, since Windows is full of security vulnerabilities. Choose a modern EDR solution that looks for unusual executions and behaviors | <b>NOTE #1:</b> Select a EDR provider you trust. But remember that the they could potentially read all files on your PC. <br></br> <b>NOTE #2:</b> Avoid installing an EDR solution, for privacy concerns, if your Windows operating system is locked down with all the recommendations in this guide applied and you only run software and documents you verified. |
...
| Standard | Use <a href="https://brave.com/"><b>Brave browser</b>  <img width="30" height="30" src="https://seeklogo.com/images/B/brave-logo-F5E1D99D9E-seeklogo.com.png"></img></a>  for <b>easy</b> security and privacy. | Brave is easy to setup and provides good built-in security and tracking protection. | |
...
| <b>Advanced</b> | Talk on encrypted chats! | I recommend <a href="https://www.signal.org"><b>Signal</b> <img width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/5/56/Logo_Signal..png"></img></a> for encrypted chat. <br></br> Emails are be often read/scanned by the hosting provider, unless you and the recipient encrypt them and manage your own private keys. |
