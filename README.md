...
<br></br>
Each recommended guideline and action is categorized by sub area (e.g. Windows) and security level, to make it easier for readers to find those that are relevant to them.
