...
| <b>Advanced</b> | Email is bad for security, <b>talk on encrypted chats!</b> | I recommend <a href="https://www.signail.org/en"><b>Signal</b> <img width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/5/56/Logo_Signal..png"></img></a> for encrypted chat. Email communication usually includes a hosting provider that can read it. | | Standard | Don't open random files! | Don't open any attached files you don't expect to receive! |
