...
| Standard-<b>Advanced</b> | Standard: Use <a href="https://brave.com/"><b>Brave</b>  <img width="30" height="30" src="https://seeklogo.com/images/B/brave-logo-F5E1D99D9E-seeklogo.com.png"></img></a> <br></br> Advanced: Use <a href="https://www.mozilla.org/en-US/firefox/"><b>Firefox</b>  <img width="30" height="30" src="https://design.firefox.com/product-identity/firefox/firefox/firefox-logo.png"></img></a> <br></br> and <br></br> <a href="https://www.torproject.org/"><b>Tor</b>  <img width="30" height="30" src="https://upload.wikimedia.org/wikipedia/commons/c/c9/Tor_Browser_icon.svg"></img></a> | Brave is easy to setup and provides good built-in security and tracking protection.<br></br> Firefox is generally the most secured and private browser if you spend some time configuring it properly, including extensions. <br></br> Tor browser should be used for the most private browsing sessions, since it connects through a Tor proxy, and it's based on Firefox and has the same security and privacy capabilities. | <b>NOTE:</b> See the Firefox and Tor sections further below for a guide on how to configure them for best security and privacy. |
